...
local CompressedString = cStringCompression.CompressStringGZIP("DataToCompress")
		...
		cWorld =
		{
			...
			Functions =
			{
				...
				BroadcastEntityAnimation = { Params = "{{cEntity|TargetEntity}}, Animation, [{{cClientHandle|ExcludeClient}}]", Return = "", Notes = "Sends an animation of an entity too all clienthandles (except ExcludeClient if given)" },
				...
				GetEndWorldName = { Params = "", Return = "string", Notes = "Returns the name of the end world this world is linked to." },
				...
				IsTrapdoorOpen = { Params = "BlockX, BlockY, BlockZ", Return = "bool", Notes = "Returns false if there is no trapdoor there or if the block isn't a trapdoor. Returns true if trapdoor is open." },
				...
				PrepareChunk = { Params = "ChunkX, ChunkZ, (Callback)", Return = "", Notes = "Queues the chunk for preparing - making sure that it's generated and lit. It is legal to call with no callback" },
				...
				SetEndWorldName = { Params = "string", Return = "", Notes = "Sets the name of the world that the end portal should link to." },
				...
				SetNetherWorldName = { Params = "string", Return = "", Notes = "Sets the name of the world that the nether portal should link to." },
