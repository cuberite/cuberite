...
a_Player:OpenWindow(Window);
		...
		cRoot =
		{
			...
			Functions =
			{
				...
				GetBrewingRecipe = { Params = "{{cItem|cItem}}, {{cItem|cItem}}", Return = "{{cItem|cItem}}", Notes = "(STATIC) Returns the brewing recipe for the bottle and the ingredient. If a recipe is found, it returns the result item. If no recipe is found, returns no value." },
