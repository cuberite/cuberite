...
public:  // tolua_export
	...
	cPlayer * GetPlayer(void) { return m_Player.lock().get(); }  // tolua_export

	auto GetStrongPlayerPtr() { return m_Player.lock(); }
	...
	*/
	...
	void QueueDataCommit(FunctionType && a_Function)
	{
		m_DataCommitQueue.emplace_back(a_Function);
	}
