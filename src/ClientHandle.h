...
public:  // tolua_export
	...
	*/
	...
	void HandleUseItem          (int a_Hand);
	void HandleRightClick       (int a_BlockX, int a_BlockY, int a_BlockZ, eBlockFace a_BlockFace, int a_CursorX, int a_CursorY, int a_CursorZ, int a_Hand);
