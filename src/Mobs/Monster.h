...
public:
	...
	*/
	...
	double GetRelativeRunSpeed(void) const { return m_RelativeRunSpeed; }  // tolua_export
	void SetRelativeRunSpeed(double a_Speed) { m_RelativeRunSpeed = a_Speed; }  // tolua_export
