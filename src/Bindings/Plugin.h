...
public:
	...
	virtual bool OnPreEnchanting            (cPlayer & a_Player, cWeightedEnchantment & a_WeightedEnchantment, cItem & a_item, int a_levels) = 0;
	virtual bool OnPostEnchanting           (cPlayer & a_Player, cEnchantments & a_Enchantment, cItem & a_item, int a_levels) = 0;
