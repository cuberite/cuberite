...
public:
	...
	*/
	...
	virtual bool OnPreEnchanting            (const cPlayer * a_Player, cEnchantments * a_Enchantment, cItem * a_item, int a_levels) override;
	virtual bool OnPostEnchanting           (const cPlayer * a_Player, cEnchantments * a_Enchantment, cItem * a_item, int a_levels) override;
