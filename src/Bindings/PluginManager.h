...
public:
	...
	enum PluginHook
	{
		...
		HOOK_EXPLODED,
		HOOK_EXPLODING,
		HOOK_EXPLOSION_BREAKING_BLOCKS,
		HOOK_HANDSHAKE,
	...
	bool CallHookExplosionBreakingBlocks  (cWorld & a_World, cVector3Container<int> & a_DestroyedBlocks, double a_X, double a_Y, double a_Z, eExplosionSource a_Source, void * a_SourceData);
