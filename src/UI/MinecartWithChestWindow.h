...
public:
		...
		m_ChestCart(a_ChestCart)
	{
		...
		a_ChestCart->GetWorld()->BroadcastSoundEffect(SoundEvent::BlockChestOpen, a_ChestCart->GetPosition(), 1, 1);
	}
	...
	{
		m_ChestCart->GetWorld()->BroadcastSoundEffect(SoundEvent::BlockChestClose, m_ChestCart->GetPosition(), 1, 1);
	}
