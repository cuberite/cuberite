	...
	a_World.ScheduleTask(1_tick, [a_BlockPos](cWorld & World)
		{
			...
			World.BroadcastSoundEffect(SoundEvent::BlockPistonExtend, a_BlockPos, 0.5f, 0.7f);
		}
	);
}
	...
	a_World.ScheduleTask(1_tick, [a_BlockPos](cWorld & World)
		{
			...
			World.BroadcastSoundEffect(SoundEvent::BlockPistonContract, a_BlockPos, 0.5f, 0.7f);
