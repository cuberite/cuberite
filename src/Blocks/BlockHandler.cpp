...
namespace
{
	...
	constexpr cDefaultBlockHandler                          BlockBambooPressurePlateHandler(BlockType::BambooPressurePlate);
	...
	constexpr cDefaultBlockHandler                          BlockCherryPressurePlateHandler(BlockType::CherryPressurePlate);
	...
	constexpr cDefaultBlockHandler                          BlockDeepslateCoalOreHandler(BlockType::DeepslateCoalOre);
	constexpr cDefaultBlockHandler                          BlockDeepslateCopperOreHandler(BlockType::DeepslateCopperOre);
	constexpr cDefaultBlockHandler                          BlockDeepslateDiamondOreHandler(BlockType::DeepslateDiamondOre);
	constexpr cDefaultBlockHandler                          BlockDeepslateEmeraldOreHandler(BlockType::DeepslateEmeraldOre);
	constexpr cDefaultBlockHandler                          BlockDeepslateGoldOreHandler(BlockType::DeepslateGoldOre);
	constexpr cDefaultBlockHandler                          BlockDeepslateIronOreHandler(BlockType::DeepslateIronOre);
	constexpr cDefaultBlockHandler                          BlockDeepslateLapisOreHandler(BlockType::DeepslateLapisOre);
	constexpr cDefaultBlockHandler                          BlockDeepslateRedstoneOreHandler(BlockType::DeepslateRedstoneOre);
	...
	constexpr cDefaultBlockHandler                          BlockMangrovePressurePlateHandler(BlockType::MangrovePressurePlate);
