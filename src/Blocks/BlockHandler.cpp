...
char cBlockHandler::FortuneDiscreteRandom(char a_MinDrop, char a_DefaultMax, unsigned int a_FortuneLevel, char a_MaxDrop)
{
	// First sample the discrete random distribution
	char DropNum = GetRandomProvider().RandInt<char>(a_MinDrop, a_DefaultMax + a_FortuneLevel);
