...
)
{
	...
	a_Chunk.UnboundedRelGetBlockMeta(a_RelPos.x, a_RelPos.y, a_RelPos.z, BlockMeta);

	if (!CanBeAt(a_ChunkInterface, a_RelPos.x, a_RelPos.y, a_RelPos.z, a_Chunk, BlockMeta))
	{
