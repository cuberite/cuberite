...
public:
	...
	virtual void BroadcastSoundEffect                (const eSoundEvent a_SoundEvent, Vector3d a_Position, float a_Volume, float a_Pitch, const cClientHandle * a_Exclude = nullptr) = 0;
