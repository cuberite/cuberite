...
*/
		...
		E_ITEM_OAK_WOOD_STAIRS = 53,
		E_ITEM_CHEST = 54,
		E_ITEM_REDSTONE_WIRE = 55,
		E_ITEM_DIAMOND_ORE = 56,
		E_ITEM_DIAMOND_BLOCK = 57,
		E_ITEM_CRAFTING_TABLE = 58,
		E_ITEM_WORKBENCH = 58,
		E_ITEM_FARMLAND = 60,
		E_ITEM_FURNACE = 61,
		E_ITEM_LIT_FURNACE = 62,
		...
		E_ITEM_DRAGON_EGG = 122,
		E_ITEM_REDSTONE_LAMP_OFF = 123,
		E_ITEM_REDSTONE_LAMP_ON = 124,
		E_ITEM_DOUBLE_WOODEN_SLAB = 125,
		E_ITEM_WOODEN_SLAB = 126,
		E_ITEM_COCOA_POD = 127,
		...
		E_ITEM_SPRUCE_WOOD_STAIRS = 134,
		E_ITEM_BIRCH_WOOD_STAIRS = 135,
		E_ITEM_JUNGLE_WOOD_STAIRS = 136,
		E_ITEM_COMMAND_BLOCK = 137,
		E_ITEM_BEACON = 138,
		E_ITEM_COBBLESTONE_WALL = 139,
		E_ITEM_CARROTS = 141,
		E_ITEM_POTATOES = 142,
		E_ITEM_WOODEN_BUTTON = 143,
		E_ITEM_ANVIL = 145,
		E_ITEM_TRAPPED_CHEST = 146,
		E_ITEM_LIGHT_WEIGHTED_PRESSURE_PLATE = 147,
		E_ITEM_HEAVY_WEIGHTED_PRESSURE_PLATE = 148,

		E_ITEM_INACTIVE_COMPARATOR = 149,
		E_ITEM_ACTIVE_COMPARATOR = 150,
		E_ITEM_DAYLIGHT_SENSOR = 151,
		E_ITEM_BLOCK_OF_REDSTONE = 152,

		E_ITEM_NETHER_QUARTZ_ORE = 153,
		E_ITEM_HOPPER = 154,
		E_ITEM_QUARTZ_BLOCK = 155,
		E_ITEM_QUARTZ_STAIRS = 156,
		E_ITEM_ACTIVATOR_RAIL = 157,

		E_ITEM_DROPPER = 158,
		E_ITEM_STAINED_CLAY = 159,  // Synonym to terracotta
		E_ITEM_TERRACOTTA = 159,  // Synonym to stained clay
		E_ITEM_STAINED_GLASS_PANE = 160,
		E_ITEM_NEW_LEAVES = 161,  // Acacia and Dark Oak IDs in Minecraft 1.7.x
		E_ITEM_NEW_LOG = 162,
		E_ITEM_ACACIA_WOOD_STAIRS = 163,
		E_ITEM_DARK_OAK_WOOD_STAIRS = 164,
		E_ITEM_SLIME_ITEM = 165,
		E_ITEM_BARRIER = 166,
		E_ITEM_IRON_TRAPDOOR = 167,
		E_ITEM_PRISMARINE_ITEM = 168,
		E_ITEM_SEA_LANTERN = 169,
		E_ITEM_HAY_BALE = 170,
		E_ITEM_CARPET = 171,
		E_ITEM_HARDENED_CLAY = 172,
		E_ITEM_BLOCK_OF_COAL = 173,
		E_ITEM_PACKED_ICE = 174,
		E_ITEM_BIG_FLOWER = 175,
		E_ITEM_STANDING_BANNER = 176,
		E_ITEM_WALL_BANNER = 177,
		E_ITEM_INVERTED_DAYLIGHT_SENSOR = 178,
		E_ITEM_RED_SANDSTONE = 179,
		E_ITEM_RED_SANDSTONE_STAIRS = 180,
		E_ITEM_DOUBLE_RED_SANDSTONE_SLAB = 181,
		E_ITEM_RED_SANDSTONE_SLAB = 182,
		E_ITEM_SPRUCE_FENCE_GATE = 183,
		E_ITEM_BIRCH_FENCE_GATE = 184,
		E_ITEM_JUNGLE_FENCE_GATE = 185,
		E_ITEM_DARK_OAK_FENCE_GATE = 186,
		E_ITEM_ACACIA_FENCE_GATE = 187,
		E_ITEM_SPRUCE_FENCE = 188,
		E_ITEM_BIRCH_FENCE = 189,
		E_ITEM_JUNGLE_FENCE = 190,
		E_ITEM_DARK_OAK_FENCE = 191,
		E_ITEM_ACACIA_FENCE = 192,
		E_ITEM_END_ROD = 198,
		E_ITEM_CHORUS_PLANT = 199,
		E_ITEM_CHORUS_FLOWER = 200,
		E_ITEM_PURPUR_BLOCK = 201,
		E_ITEM_PURPUR_PILLAR = 202,
		E_ITEM_PURPUR_STAIRS = 203,
		E_ITEM_PURPUR_DOUBLE_SLAB = 204,
		E_ITEM_PURPUR_SLAB = 205,
		E_ITEM_END_BRICKS = 206,
		E_ITEM_BEETROOTS = 207,
		E_ITEM_GRASS_PATH = 208,
		E_ITEM_END_GATEWAY = 209,
		E_ITEM_REPEATING_COMMAND_BLOCK = 210,
		E_ITEM_CHAIN_COMMAND_BLOCK = 211,
		E_ITEM_FROSTED_ICE = 212,
		E_ITEM_MAGMA = 213,
		E_ITEM_NETHER_WART_BLOCK = 214,
		E_ITEM_RED_NETHER_BRICK = 215,
		E_ITEM_BONE_ITEM = 216,
		E_ITEM_STRUCTURE_VOID = 217,
		E_ITEM_OBSERVER = 218,
		E_ITEM_WHITE_SHULKER_BOX = 219,
		E_ITEM_ORANGE_SHULKER_BOX = 220,
		E_ITEM_MAGENTA_SHULKER_BOX = 221,
		E_ITEM_LIGHT_BLUE_SHULKER_BOX = 222,
		E_ITEM_YELLOW_SHULKER_BOX = 223,
		E_ITEM_LIME_SHULKER_BOX = 224,
		E_ITEM_PINK_SHULKER_BOX = 225,
		E_ITEM_GRAY_SHULKER_BOX = 226,
		E_ITEM_LIGHT_GRAY_SHULKER_BOX = 227,
		E_ITEM_CYAN_SHULKER_BOX = 228,
		E_ITEM_PURPLE_SHULKER_BOX = 229,
		E_ITEM_BLUE_SHULKER_BOX = 230,
		E_ITEM_BROWN_SHULKER_BOX = 231,
		E_ITEM_GREEN_SHULKER_BOX = 232,
		E_ITEM_RED_SHULKER_BOX = 233,
		E_ITEM_BLACK_SHULKER_BOX = 234,
		E_ITEM_WHITE_GLAZED_TERRACOTTA = 235,
		E_ITEM_ORANGE_GLAZED_TERRACOTTA = 236,
		E_ITEM_MAGENTA_GLAZED_TERRACOTTA = 237,
		E_ITEM_LIGHT_BLUE_GLAZED_TERRACOTTA = 238,
		E_ITEM_YELLOW_GLAZED_TERRACOTTA = 239,
		E_ITEM_LIME_GLAZED_TERRACOTTA = 240,
		E_ITEM_PINK_GLAZED_TERRACOTTA = 241,
		E_ITEM_GRAY_GLAZED_TERRACOTTA = 242,
		E_ITEM_LIGHT_GRAY_GLAZED_TERRACOTTA = 243,
		E_ITEM_CYAN_GLAZED_TERRACOTTA = 244,
		E_ITEM_PURPLE_GLAZED_TERRACOTTA = 245,
		E_ITEM_BLUE_GLAZED_TERRACOTTA = 246,
		E_ITEM_BROWN_GLAZED_TERRACOTTA = 247,
		E_ITEM_GREEN_GLAZED_TERRACOTTA = 248,
		E_ITEM_RED_GLAZED_TERRACOTTA = 249,
		E_ITEM_BLACK_GLAZED_TERRACOTTA = 250,
		E_ITEM_CONCRETE = 251,
		E_ITEM_CONCRETE_POWDER = 252,
		// ...
		E_ITEM_STRUCTURE_ITEM = 255,
		E_BLOCK_NUMBER_OF_TYPES = E_ITEM_CONCRETE_POWDER + 1,  ///< Number of individual (different) blocktypes
