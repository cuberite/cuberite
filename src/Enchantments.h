...
public:
	...
	*/
	...
	static bool cEnchantments::IsValidEnchantment(int a_ItemType, int a_EnchantmentID);

	//** Check level caps on enchantment */
	static int cEnchantments::GetLevelCap(int a_EnchantmentID, unsigned int a_EnchantmentLevel);
