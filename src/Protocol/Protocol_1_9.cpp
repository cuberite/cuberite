...
void cProtocol_1_9_0::HandlePacketStatusRequest(cByteBuffer & a_ByteBuffer)
{
	...
	m_Client->m_ForgeHandshake.AugmentServerListPing("1.9.0", ResponseValue);
	if (!Favicon.empty())
	{
...
void cProtocol_1_9_1::HandlePacketStatusRequest(cByteBuffer & a_ByteBuffer)
{
	...
	ResponseValue["players"] = Players;
	ResponseValue["description"] = Description;
	m_Client->m_ForgeHandshake.AugmentServerListPing("1.9.1", ResponseValue);
	if (!Favicon.empty())
	{
		ResponseValue["favicon"] = Printf("data:image/png;base64,%s", Favicon.c_str());
	}
...
void cProtocol_1_9_2::HandlePacketStatusRequest(cByteBuffer & a_ByteBuffer)
{
	...
	ResponseValue["players"] = Players;
	ResponseValue["description"] = Description;
	m_Client->m_ForgeHandshake.AugmentServerListPing("1.9.2", ResponseValue);
	if (!Favicon.empty())
	{
		ResponseValue["favicon"] = Printf("data:image/png;base64,%s", Favicon.c_str());
	}
...
void cProtocol_1_9_4::HandlePacketStatusRequest(cByteBuffer & a_ByteBuffer)
{
	...
	ResponseValue["players"] = Players;
	ResponseValue["description"] = Description;
	m_Client->m_ForgeHandshake.AugmentServerListPing("1.9.4", ResponseValue);
	if (!Favicon.empty())
	{
		ResponseValue["favicon"] = Printf("data:image/png;base64,%s", Favicon.c_str());
	}
