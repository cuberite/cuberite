...
public:
	...
	cProtocol172(cClientHandle * a_Client, const AString & a_ServerAddress, uint16_t a_ServerPort, uint32_t a_State);
...
protected:
	...
	{
	public:
		cPacketizer(cProtocol172 & a_Protocol, uint32_t a_PacketType) :
...
public:
	cProtocol176(cClientHandle * a_Client, const AString & a_ServerAddress, uint16_t a_ServerPort, uint32_t a_State);
