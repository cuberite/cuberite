...
class cChunkDataSerializer
{
  ...
  */
	template <auto Palette>
	inline void WriteBlockSectionSeamless(
	...
	inline void WriteLightSectionGrouped(
		const ChunkLightData::LightArray * a_BlockLights,
