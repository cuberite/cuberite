...
namespace Palette_1_21_6
{
	UInt32 From(const BlockState Block)
	{
		return cRoot::Get()->GetBlockMap()->GetProtocolBlockId(cProtocol::Version::v1_21_6, Block);
	}
	...
	{
		return cRoot::Get()->GetRegistryMap()->BlockTypeToProtocol(a_Block, cProtocol::Version::v1_21_6);
	}
	...
	{
		return cRoot::Get()->GetRegistryMap()->ProtocolToItem(ID, cProtocol::Version::v1_21_6);
	}
	UInt32 From(const Item ID)
	{
		return cRoot::Get()->GetRegistryMap()->ItemToProtocol(ID, cProtocol::Version::v1_21_6);
	}
