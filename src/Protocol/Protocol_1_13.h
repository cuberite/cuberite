...
protected:
	...
	virtual void ParseItemMetadata(cItem & a_Item, const ContiguousByteBufferView a_Metadata) const override;
	...
	virtual void WriteItemNBT(cPacketizer & a_Pkt, const cItem & a_Item) const;
