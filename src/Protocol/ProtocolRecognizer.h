...
public:
	...
	virtual void SendScoreUpdate                (const AString & a_Objective, const AString & a_Key, cObjective::Score a_Score, cScoreboard::eUpdateAction a_Mode) override;
	...
	virtual void SendTeam                       (const cTeam & a_Team, cTeam::eProtocolAction a_Mode) override;
