...
public:
	...
	virtual void SendMapColumn                  (int a_ID, int a_X, int a_Y, const uint8_t * a_Colors, unsigned int a_Length, unsigned int m_Scale) = 0;
	...
	virtual void SendScoreboardObjective        (const AString & a_Name, const AString & a_DisplayName, uint8_t a_Mode) = 0;
	virtual void SendScoreUpdate                (const AString & a_Objective, const AString & a_Player, cObjective::Score a_Score, uint8_t a_Mode) = 0;
	...
	virtual void SendSpawnObject                (const cEntity & a_Entity, char a_ObjectType, int a_ObjectData, uint8_t a_Yaw, uint8_t a_Pitch) = 0;
	...
	virtual void SendTimeUpdate                 (int64_t a_WorldAge, int64_t a_TimeOfDay, bool a_DoDaylightCycle) = 0;
