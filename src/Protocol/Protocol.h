...
public:
	...
	enum class EntityMetadata
	{
		...
		TntFuse,
		TntBlockState,
		EndCrystalBeamTarget,
		EndCrystalShowBottom,
		InteractionWidth,
		InteractionHeight,
		InteractionResponse,
		LivingLivingFlags,
		LivingHealth,
		LivingPotionSwirls,
		LivingPotionSwirlsAmbient,
		LivingStuckArrowCount,
		LivingStingerCount,
		LivingSleepingPosition,
		PlayerAbsorptionAmount,
		PlayerScore,
		PlayerPlayerModelParts,
		PlayerMainArm,
		PlayerLeftShoulderEntity,
		PlayerRightShoulderEntity,
		ArmorStandArmorStandFlags,
		ArmorStandTrackerHeadRotation,
		ArmorStandTrackerBodyRotation,
		ArmorStandTrackerLeftArmRotation,
		ArmorStandTrackerRightArmRotation,
		ArmorStandTrackerLeftLegRotation,
		ArmorStandTrackerRightLegRotation,
		MobMobFlags,
		BatBatFlags,
		PhantomSize,
		GhastShooting,
		...
		ShulkerPeekAmount,
		ShulkerColor,
		SnowGolemSnowGolemFlags,
		IronGolemIronGolemFlags,
		FishFromBucket,
		PufferfishPuffState,
		TropicalFishVariant,
		SalmonVariant,
		PassiveChild,
		MerchantHeadRollingTimeLeft,
		VillagerVillagerData,
		DolphinTreasurePos,
		DolphinHasFish,
		DolphinMoistness,
		GlowSquidDarkTicksRemaining,
		BeeBeeFlags,
		BeeAnger,
		PigSaddled,
		PigBoostTime,
		...
		OcelotTrusting,
		SnifferState,
		SnifferFinishDigTime,
		TameableTameableFlags,
		TameableOwnerUuid,
		WolfBegging,
		WolfCollarColor,
		WolfAngerTime,
		...
		ParrotVariant,
		HoglinBaby,
		WitherTrackedEntityId1,
		WitherTrackedEntityId2,
		WitherTrackedEntityId3,
		WitherInvulTimer,
		WardenAnger,
		ZombieBaby,
		ZombieZombieType,
		ZombieConvertingInWater,
		...
		ZoglinBaby,
		VexVexFlags,
		GuardianSpikesRetracted,
		GuardianBeamTargetId,
		SkeletonConverting,
		BoggedSheared,
		RaiderCelebrating,
		PillagerCharging,
		SpellcastingIllagerSpell,
		WitchDrinking,
		...
		SlimeSlimeSize,
		VehicleDamageWobbleTicks,
		VehicleDamageWobbleSide,
		VehicleDamageWobbleStrength,
		AbstractMinecartCustomBlockId,
		AbstractMinecartCustomBlockOffset,
		AbstractMinecartCustomBlockPresent,
		FurnaceMinecartLit,
		CommandBlockMinecartCommand,
		CommandBlockMinecartLastOutput,
		AbstractBoatLeftPaddleMoving,
		AbstractBoatRightPaddleMoving,
		AbstractBoatBubbleWobbleTicks,
		FishingBobberHookEntityId,
		FishingBobberCaughtFish,
		PersistentProjectileProjectileFlags,
		PersistentProjectilePierceLevel,
		PersistentProjectileInGround,
		TridentLoyalty,
		TridentEnchanted,
		ArrowColor,
		AbstractFireballItem,
		WitherSkullCharged,
		ThrownItemItem,
		FireworkRocketItem,
		FireworkRocketShooterEntityId,
		FireworkRocketShotAtAngle,
		OminousItemSpawnerItem,
		ItemStack,
		DisplayStartInterpolation,
		DisplayInterpolationDuration,
		DisplayTeleportDuration,
		DisplayTranslation,
		DisplayScale,
		DisplayLeftRotation,
		DisplayRightRotation,
		DisplayBillboard,
		DisplayBrightness,
		DisplayViewRange,
		DisplayShadowRadius,
		DisplayShadowStrength,
		DisplayWidth,
		DisplayHeight,
		DisplayGlowColorOverride,
		TextDisplayText,
		TextDisplayLineWidth,
		TextDisplayBackground,
		TextDisplayTextOpacity,
		TextDisplayTextDisplayFlags,
		ItemDisplayItem,
		ItemDisplayItemDisplay,
		BlockDisplayBlockState,
		EyeOfEnderItem,
		FallingBlockBlockPos,
		PaintingVariant,
		ItemFrameItemStack,
		ItemFrameRotation,
