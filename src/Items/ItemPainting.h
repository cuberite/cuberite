...
public:
	...
	) override
	{
		...
		if (Block == E_BLOCK_AIR)
		{
			...
			auto Painting = std::make_shared<cPainting>(gPaintingTitlesList[a_World->GetTickRandomNumber(ARRAYCOUNT(gPaintingTitlesList) - 1)].Title, a_BlockFace, a_BlockX, a_BlockY, a_BlockZ);
			Painting->Initialize(Painting, *a_World);
