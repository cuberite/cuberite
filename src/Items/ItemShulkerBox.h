...
public:
	...
	) override
	{
		...
		NIBBLETYPE ShulkerBoxMeta = static_cast<NIBBLETYPE>(a_ClickedBlockFace);

		// Place the new shulker box:
		if (!a_Player.PlaceBlock(PlacePos.x, PlacePos.y, PlacePos.z, ShulkerBoxType, ShulkerBoxMeta))
		{
			return false;
		}
