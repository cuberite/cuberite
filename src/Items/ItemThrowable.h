...
public:
	...
	) const override
	{
		...
		// Play sound:
		a_World->BroadcastSoundEffect(SoundEvent::ArrowShoot, a_Player->GetPosition() - Vector3d(0, a_Player->GetHeight(), 0), 0.5f, 0.4f / GetRandomProvider().RandReal(0.8f, 1.2f));
