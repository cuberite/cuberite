...
public:
	...
	*/
	...
	void DoExplosionAt(double a_ExplosionSize, double a_BlockX, double a_BlockY, double a_BlockZ, cVector3iArray & a_BlockAffected, eExplosionSource a_Source, void * a_SourceData);
