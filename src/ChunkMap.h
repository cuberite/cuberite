...
public:
	...
	*/
	...
	void       QueueSetBlock     (int a_BlockX, int a_BlockY, int a_BlockZ, BLOCKTYPE a_BlockType, NIBBLETYPE a_BlockMeta, int64_t a_Tick, BLOCKTYPE a_PreviousBlockType = E_BLOCK_AIR);
