...
protected:
	...
	typedef std::array<int,    17 * 17> IntMap;  // x + 17 * z, expected trimmed into [0..255] range
	typedef std::array<double, 17 * 17> DblMap;  // x + 17 * z, expected trimmed into [0..1] range
