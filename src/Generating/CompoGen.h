...
class cCompoGenSameBlock : public cTerrainCompositionGen
{
  public:
	cCompoGenSameBlock(void) :
		m_BlockType(E_BLOCK_STONE), m_IsBedrocked(true)
	{
	}
...
class cCompoGenDebugBiomes : public cTerrainCompositionGen
{
  public:
...
class cCompoGenClassic : public cTerrainCompositionGen
{
  public:
...
class cCompoGenNether : public cTerrainCompositionGen
{
  public:
...
class cCompoGenCache : public cTerrainCompositionGen
{
  public:
