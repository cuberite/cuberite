...
public:
	...
	void       SetBlock(int a_RelX, int a_RelY, int a_RelZ, BlockState a_Block);
	...
	void GetBlock(int a_RelX, int a_RelY, int a_RelZ, BlockState & a_Block) const;
	BlockState GetBlock(Vector3i a_RelPos);
	// tolua_begin
