...
class cStructGenMarbleCaves : public cFinishGen
{
  public:
...
class cStructGenDualRidgeCaves : public cFinishGen
{
  public:
	cStructGenDualRidgeCaves(int a_Seed, float a_Threshold) :
		m_Noise1(a_Seed), m_Noise2(2 * a_Seed + 19999), m_Seed(a_Seed), m_Threshold(a_Threshold)
	{
	}
...
class cStructGenWormNestCaves : public cGridStructGen
{
