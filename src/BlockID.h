...
enum
{
	...
	E_META_NEWLEAVES_APPLE   = 0,
	E_META_NEWLEAVES_CONIFER = 1,
	E_META_NEWLEAVES_BIRCH   = 2,
	E_META_NEWLEAVES_JUNGLE  = 3,
	E_META_NEWLEAVES_APPLE_NO_DECAY = 4,
	E_META_NEWLEAVES_CONIFER_NO_DECAY = 5,
	E_META_NEWLEAVES_BIRCH_NO_DECAY = 6,
	E_META_NEWLEAVES_JUNGLE_NO_DECAY = 7,
	E_META_NEWLEAVES_APPLE_CHECK_DECAY = 8,
	E_META_NEWLEAVES_CONIFER_CHECK_DECAY = 9,
	E_META_NEWLEAVES_BIRCH_CHECK_DECAY = 10,
	E_META_NEWLEAVES_JUNGLE_CHECK_DECAY = 11,
	...
	E_META_NEWLEAVES_ACACIA_NO_DECAY_CHECK_DECAY       = 12,
	E_META_NEWLEAVES_DARK_OAK_NO_DECAY_CHECK_DECAY     = 13,
	
	// E_BLOCK_LOG metas:
	E_META_NEWLOG_APPLE   = 0,
	E_META_NEWLOG_CONIFER = 1,
	E_META_NEWLOG_BIRCH   = 2,
	E_META_NEWLOG_JUNGLE  = 3,
	...
	// E_META_LOG metas:
	E_META_NEWLOG_OAK_UP_DOWN        = 0,
	E_META_NEWLOG_SPRUCE_UP_DOWN     = 1,
	E_META_NEWLOG_BIRCH_UP_DOWN      = 2,
	E_META_NEWLOG_JUNGLE_UP_DOWN     = 3,
	E_META_NEWLOG_OAK_X      = 4,
	E_META_NEWLOG_SPRUCE_X   = 5,
	E_META_NEWLOG_BIRCH_X    = 6,
	E_META_NEWLOG_JUNGLE_X   = 7,
	E_META_NEWLOG_OAK_Z    = 8,
	E_META_NEWLOG_SPRUCE_Z = 9,
	E_META_NEWLOG_BIRCH_Z  = 10,
	E_META_NEWLOG_JUNGLE_Z = 11,
	E_META_NEWLOG_OAK_BARK_ONLY      = 12,
	E_META_NEWLOG_SPRUCE_BARK_ONLY   = 13,
	E_META_NEWLOG_BIRCH_BARK_ONLY    = 14,
	E_META_NEWLOG_JUNGLE_BARK_ONLY   = 15,

	// E_META_NEWLOG metas cont. (Block ID 162):
	E_META_NEWLOG_ACACIA_UP_DOWN = 0,
	E_META_NEWLOG_DARK_OAK_UP_DOWN = 1,
	E_META_NEWLOG_ACACIA_UP_DOWN = 2,
	E_META_NEWLOG_DARK_OAK_UP_DOWN = 3,
	E_META_NEWLOG_ACACIA_X = 4,
	E_META_NEWLOG_DARK_OAK_X = 5,
	E_META_NEWLOG_ACACIA_X = 6,
	E_META_NEWLOG_DARK_OAK_X = 7,
	E_META_NEWLOG_ACACIA_Z = 8,
	E_META_NEWLOG_DARK_OAK_Z = 9,
	E_META_NEWLOG_ACACIA_Z = 10,
	E_META_NEWLOG_DARK_OAK_Z = 11,
	E_META_NEWLOG_ACACIA_BARK_ONLY = 12,
	E_META_NEWLOG_DARK_OAK_BARK_ONLY = 13,
	E_META_NEWLOG_ACACIA_BARK_ONLY = 14,
	E_META_NEWLOG_DARK_OAK_BARK_ONLY = 15,
