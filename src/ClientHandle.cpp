...
void cClientHandle::HandleLeftClick(int a_BlockX, int a_BlockY, int a_BlockZ, eBlockFace a_BlockFace, UInt8 a_Status)
{
	...
	switch (a_Status)
	{
		...
		{
			auto & ItemHandler = cItemHandler::For(m_Player->GetEquippedItem());
			...
			else
			{
				...
				{
					cItemHandler::For(m_Player->GetInventory().GetShieldSlot()).OnItemShoot(m_Player, {a_BlockX, a_BlockY, a_BlockZ}, a_BlockFace);
				}
				else
				{
...
void cClientHandle::HandleBlockDigStarted(int a_BlockX, int a_BlockY, int a_BlockZ, eBlockFace a_BlockFace)
{
	...
	cItemHandler::For(m_Player->GetEquippedItem()).OnDiggingBlock(World, m_Player, m_Player->GetEquippedItem(), {a_BlockX, a_BlockY, a_BlockZ}, a_BlockFace);
}
...
void cClientHandle::HandleRightClick(int a_BlockX, int a_BlockY, int a_BlockZ, eBlockFace a_BlockFace, int a_CursorX, int a_CursorY, int a_CursorZ, bool a_UsedMainHand)
{
	...
	auto & ItemHandler = cItemHandler::For(HeldItem.m_ItemType);
