...
public:
	...
	*/
	...
	void      GetBlockTypeMeta(Vector3i a_Location, BLOCKTYPE & a_BlockType, NIBBLETYPE & a_BlockMeta) const;
	void      GetBlockTypeMeta(Vector3d a_Location, BLOCKTYPE & a_BlockType, NIBBLETYPE & a_BlockMeta) const;
