...
#define ACACIALOGS_TAG \
	cItem(E_BLOCK_NEW_LOG, 1, E_META_NEW_LOG_ACACIA_WOOD)
	// cItem(E_BLOCK_ACACIA_WOOD), \
	// cItem(E_BLOCK_STRIPPED_ACACIA_LOG), \
	// cItem(E_BLOCK_STRIPPED_ACACIA_WOOD)

// TODO: 07.09.2020 Add when implemented - 12xx12
#define BIRCHLOGS_TAG \
...
#define CREEPERDROPMUSICDISCS_TAG \
...
#define LECTERNBOOKS_TAG \
		cItem(E_ITEM_BOOK_AND_QUILL), \
		cItem(E_ITEM_WRITTEN_BOOK)

// TODO: 14.10.2020 - Add when implemented - 12xx12
#define LOGS_TAG \
	LOGSTHATBURN_TAG
	// CRIMSONSTEMS_TAG,
	// WARPEDSTEMS_TAG

#define MUSICDISCS_TAG \
	CREEPERDROPMUSICDISCS_TAG
	// cItem(E_ITEM_DISC_PIGSTEP)

#define NONFLAMEABLEWOOD_TAG \
		/* TODO: 07.09.2020 - Add when implemented - 12xx12
		cItem(E_BLOCK_WARPED_STEM),
		cItem(E_BLOCK_STRIPPED_WARPED_STEM),
		cItem(E_BLOCK_WARPED_HYPHAE),
...
// TODO: 07.09.2020 - Add when implemented - 12xx12
#define WOODENPREASSUREPLATES_TAG \
