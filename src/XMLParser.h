...
template <class _T> class CExpatImpl
{
  ...
  protected:
	...
	{
		assert(m_p != nullptr);
		XML_SetEndDoctypeDeclHandler(m_p, fEnable ? EndDoctypeDeclHandler : nullptr);
	}
  ...
  public:
	...
	const XML_LChar * GetErrorString() { return XML_ErrorString(GetErrorCode()); }
	...
	static const XML_LChar * GetErrorString(enum XML_Error nError) { return XML_ErrorString(nError); }
	...
	void OnStartElement(const XML_Char * pszName, const XML_Char ** papszAttrs) { return; }

	// @cmember End element handler

	void OnEndElement(const XML_Char * pszName) { return; }

	// @cmember Character data handler

	void OnCharacterData(const XML_Char * pszData, int nLength) { return; }

	// @cmember Processing instruction handler

	void OnProcessingInstruction(const XML_Char * pszTarget, const XML_Char * pszData) { return; }

	// @cmember Comment handler

	void OnComment(const XML_Char * pszData) { return; }
	...
	void OnDefault(const XML_Char * pszData, int nLength) { return; }
	...
	void OnStartNamespaceDecl(const XML_Char * pszPrefix, const XML_Char * pszURI) { return; }
	...
	void OnXmlDecl(const XML_Char * pszVersion, const XML_Char * pszEncoding, bool fStandalone) { return; }
  ...
  protected:
	...
	static void __cdecl ProcessingInstructionHandler(
		void * pUserData,
	...
	static int __cdecl ExternalEntityRefHandler(
		void * pUserData,
		const XML_Char * pszContext,
		const XML_Char * pszBase,
		const XML_Char * pszSystemID,
	...
	static void __cdecl XmlDeclHandler(
		void * pUserData,
