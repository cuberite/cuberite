...
cBlockInfo::cBlockInfoArray::cBlockInfoArray()
{
	...
	*/
	...
	// Blast resistance
	// Because the blast resistance is only used in explosions this way: ((BR / 5) + 0.3) * 0.3, are these values pre-modified
	Info[E_BLOCK_AIR                          ].m_BlastResistance = 0.09f;  // Air is not checked by the algorithm
	Info[E_BLOCK_STONE                        ].m_BlastResistance = 1.89f;  // 30
	Info[E_BLOCK_GRASS                        ].m_BlastResistance = 0.27f;  // 3
	Info[E_BLOCK_DIRT                         ].m_BlastResistance = 0.24f;  // 2.5
	Info[E_BLOCK_COBBLESTONE                  ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_PLANKS                       ].m_BlastResistance = 0.99f;  // 15
	Info[E_BLOCK_SAPLING                      ].m_BlastResistance = 0.09f;  // 0
	Info[E_BLOCK_BEDROCK                      ].m_BlastResistance = 1080000.09f;  // 18mio
	Info[E_BLOCK_WATER                        ].m_BlastResistance = 30.09f;  // 500
	Info[E_BLOCK_STATIONARY_WATER             ].m_BlastResistance = 30.09f;
	Info[E_BLOCK_LAVA                         ].m_BlastResistance = 30.09f;
	Info[E_BLOCK_STATIONARY_LAVA              ].m_BlastResistance = 30.09f;
	Info[E_BLOCK_SAND                         ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_GRAVEL                       ].m_BlastResistance = 0.27f;
	Info[E_BLOCK_GOLD_ORE                     ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_IRON_ORE                     ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_COAL_ORE                     ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_LOG                          ].m_BlastResistance = 0.69f;  // 10
	Info[E_BLOCK_LEAVES                       ].m_BlastResistance = 0.15f;  // 1
	Info[E_BLOCK_SPONGE                       ].m_BlastResistance = 0.27f;
	Info[E_BLOCK_GLASS                        ].m_BlastResistance = 0.18f;  // 1.5
	Info[E_BLOCK_LAPIS_ORE                    ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_LAPIS_BLOCK                  ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_DISPENSER                    ].m_BlastResistance = 1.14f;  // 17.5
	Info[E_BLOCK_SANDSTONE                    ].m_BlastResistance = 0.36f;  // 4
	Info[E_BLOCK_NOTE_BLOCK                   ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_BED                          ].m_BlastResistance = 0.15f;
	Info[E_BLOCK_POWERED_RAIL                 ].m_BlastResistance = 0.3f;  // 3.5
	Info[E_BLOCK_DETECTOR_RAIL                ].m_BlastResistance = 0.3f;
	Info[E_BLOCK_STICKY_PISTON                ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_COBWEB                       ].m_BlastResistance = 1.29f;  // 20
	Info[E_BLOCK_TALL_GRASS                   ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_DEAD_BUSH                    ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_PISTON                       ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_PISTON_EXTENSION             ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_WOOL                         ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_PISTON_MOVED_BLOCK           ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_DANDELION                    ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_FLOWER                       ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_BROWN_MUSHROOM               ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_RED_MUSHROOM                 ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_GOLD_BLOCK                   ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_IRON_BLOCK                   ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_DOUBLE_STONE_SLAB            ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_STONE_SLAB                   ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_BRICK                        ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_TNT                          ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_BOOKCASE                     ].m_BlastResistance = 0.54f;  // 7.5
	Info[E_BLOCK_MOSSY_COBBLESTONE            ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_OBSIDIAN                     ].m_BlastResistance = 360.09f;  // 6000
	Info[E_BLOCK_TORCH                        ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_FIRE                         ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_MOB_SPAWNER                  ].m_BlastResistance = 1.59f;  // 25
	Info[E_BLOCK_OAK_WOOD_STAIRS              ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_CHEST                        ].m_BlastResistance = 0.84f;  // 12.5
	Info[E_BLOCK_REDSTONE_WIRE                ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_DIAMOND_ORE                  ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_DIAMOND_BLOCK                ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_CRAFTING_TABLE               ].m_BlastResistance = 0.84f;
	Info[E_BLOCK_CROPS                        ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_FARMLAND                     ].m_BlastResistance = 0.27f;
	Info[E_BLOCK_FURNACE                      ].m_BlastResistance = 1.14f;
	Info[E_BLOCK_LIT_FURNACE                  ].m_BlastResistance = 1.14f;
	Info[E_BLOCK_SIGN_POST                    ].m_BlastResistance = 0.39f;  // 5
	Info[E_BLOCK_OAK_DOOR                     ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_LADDER                       ].m_BlastResistance = 0.21f;  // 2
	Info[E_BLOCK_RAIL                         ].m_BlastResistance = 0.3f;
	Info[E_BLOCK_COBBLESTONE_STAIRS           ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_WALLSIGN                     ].m_BlastResistance = 0.39f;
	Info[E_BLOCK_LEVER                        ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_STONE_PRESSURE_PLATE         ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_IRON_DOOR                    ].m_BlastResistance = 1.59f;
	Info[E_BLOCK_WOODEN_PRESSURE_PLATE        ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_REDSTONE_ORE                 ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_REDSTONE_ORE_GLOWING         ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_REDSTONE_TORCH_OFF           ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_REDSTONE_TORCH_ON            ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_STONE_BUTTON                 ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_SNOW                         ].m_BlastResistance = 0.12f;
	Info[E_BLOCK_ICE                          ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_SNOW_BLOCK                   ].m_BlastResistance = 0.15f;
	Info[E_BLOCK_CACTUS                       ].m_BlastResistance = 0.21f;
	Info[E_BLOCK_CLAY                         ].m_BlastResistance = 0.27f;
	Info[E_BLOCK_SUGARCANE                    ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_JUKEBOX                      ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_FENCE                        ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_PUMPKIN                      ].m_BlastResistance = 0.39f;
	Info[E_BLOCK_NETHERRACK                   ].m_BlastResistance = 0.21f;
	Info[E_BLOCK_SOULSAND                     ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_GLOWSTONE                    ].m_BlastResistance = 0.18f;
	Info[E_BLOCK_NETHER_PORTAL                ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_JACK_O_LANTERN               ].m_BlastResistance = 0.39f;
	Info[E_BLOCK_CAKE                         ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_REDSTONE_REPEATER_OFF        ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_REDSTONE_REPEATER_ON         ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_STAINED_GLASS                ].m_BlastResistance = 0.18f;
	Info[E_BLOCK_TRAPDOOR                     ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_SILVERFISH_EGG               ].m_BlastResistance = 0.09f;  // ?
	Info[E_BLOCK_STONE_BRICKS                 ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_HUGE_BROWN_MUSHROOM          ].m_BlastResistance = 0.15f;
	Info[E_BLOCK_HUGE_RED_MUSHROOM            ].m_BlastResistance = 0.15f;
	Info[E_BLOCK_IRON_BARS                    ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_GLASS_PANE                   ].m_BlastResistance = 0.18f;
	Info[E_BLOCK_MELON                        ].m_BlastResistance = 0.39f;
	Info[E_BLOCK_PUMPKIN_STEM                 ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_MELON_STEM                   ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_VINES                        ].m_BlastResistance = 0.15f;
	Info[E_BLOCK_OAK_FENCE_GATE               ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_BRICK_STAIRS                 ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_STONE_BRICK_STAIRS           ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_MYCELIUM                     ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_LILY_PAD                     ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_NETHER_BRICK                 ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_NETHER_BRICK_FENCE           ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_NETHER_BRICK_STAIRS          ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_NETHER_WART                  ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_ENCHANTMENT_TABLE            ].m_BlastResistance = 360.09f;
	Info[E_BLOCK_BREWING_STAND                ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_CAULDRON                     ].m_BlastResistance = 0.69f;
	Info[E_BLOCK_END_PORTAL                   ].m_BlastResistance = 1080000.09f;
	Info[E_BLOCK_END_PORTAL_FRAME             ].m_BlastResistance = 1080000.09f;
	Info[E_BLOCK_END_STONE                    ].m_BlastResistance = 2.79f;  // 45
	Info[E_BLOCK_DRAGON_EGG                   ].m_BlastResistance = 2.79f;
	Info[E_BLOCK_REDSTONE_LAMP_OFF            ].m_BlastResistance = 0.18f;
	Info[E_BLOCK_REDSTONE_LAMP_ON             ].m_BlastResistance = 0.18f;
	Info[E_BLOCK_DOUBLE_WOODEN_SLAB           ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_WOODEN_SLAB                  ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_COCOA_POD                    ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_SANDSTONE_STAIRS             ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_EMERALD_ORE                  ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_ENDER_CHEST                  ].m_BlastResistance = 180.09f;  // 3000
	Info[E_BLOCK_TRIPWIRE_HOOK                ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_TRIPWIRE                     ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_EMERALD_BLOCK                ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_SPRUCE_WOOD_STAIRS           ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_BIRCH_WOOD_STAIRS            ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_JUNGLE_WOOD_STAIRS           ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_COMMAND_BLOCK                ].m_BlastResistance = 1080000.09f;
	Info[E_BLOCK_BEACON                       ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_COBBLESTONE_WALL             ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_FLOWER_POT                   ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_CARROTS                      ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_POTATOES                     ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_WOODEN_BUTTON                ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_HEAD                         ].m_BlastResistance = 0.39f;
	Info[E_BLOCK_ANVIL                        ].m_BlastResistance = 360.09f;
	Info[E_BLOCK_TRAPPED_CHEST                ].m_BlastResistance = 0.84f;
	Info[E_BLOCK_LIGHT_WEIGHTED_PRESSURE_PLATE].m_BlastResistance = 0.24f;
	Info[E_BLOCK_HEAVY_WEIGHTED_PRESSURE_PLATE].m_BlastResistance = 0.24f;
	Info[E_BLOCK_INACTIVE_COMPARATOR          ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_ACTIVE_COMPARATOR            ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_DAYLIGHT_SENSOR              ].m_BlastResistance = 0.15f;
	Info[E_BLOCK_BLOCK_OF_REDSTONE            ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_NETHER_QUARTZ_ORE            ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_HOPPER                       ].m_BlastResistance = 1.53f;  // 24
	Info[E_BLOCK_QUARTZ_BLOCK                 ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_QUARTZ_STAIRS                ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_ACTIVATOR_RAIL               ].m_BlastResistance = 0.3f;
	Info[E_BLOCK_DROPPER                      ].m_BlastResistance = 1.14f;
	Info[E_BLOCK_STAINED_CLAY                 ].m_BlastResistance = 1.35f;  // 21
	Info[E_BLOCK_STAINED_GLASS_PANE           ].m_BlastResistance = 0.18f;
	Info[E_BLOCK_NEW_LEAVES                   ].m_BlastResistance = 0.15f;
	Info[E_BLOCK_NEW_LOG                      ].m_BlastResistance = 0.69f;
	Info[E_BLOCK_ACACIA_WOOD_STAIRS           ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_DARK_OAK_WOOD_STAIRS         ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_SLIME_BLOCK                  ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_BARRIER                      ].m_BlastResistance = 1080000.09f;
	Info[E_BLOCK_IRON_TRAPDOOR                ].m_BlastResistance = 1.59f;
	Info[E_BLOCK_PRISMARINE_BLOCK             ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_SEA_LANTERN                  ].m_BlastResistance = 0.18f;
	Info[E_BLOCK_HAY_BALE                     ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_CARPET                       ].m_BlastResistance = 0.12f;  // 0.5
	Info[E_BLOCK_HARDENED_CLAY                ].m_BlastResistance = 1.35f;  // 21
	Info[E_BLOCK_BLOCK_OF_COAL                ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_PACKED_ICE                   ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_BIG_FLOWER                   ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_STANDING_BANNER              ].m_BlastResistance = 0.39f;
	Info[E_BLOCK_WALL_BANNER                  ].m_BlastResistance = 0.39f;
	Info[E_BLOCK_INVERTED_DAYLIGHT_SENSOR     ].m_BlastResistance = 0.15f;
	Info[E_BLOCK_RED_SANDSTONE                ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_RED_SANDSTONE_STAIRS         ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_DOUBLE_RED_SANDSTONE_SLAB    ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_RED_SANDSTONE_SLAB           ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_SPRUCE_FENCE_GATE            ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_BIRCH_FENCE_GATE             ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_JUNGLE_FENCE_GATE            ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_DARK_OAK_FENCE_GATE          ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_ACACIA_FENCE_GATE            ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_SPRUCE_FENCE                 ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_BIRCH_FENCE                  ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_JUNGLE_FENCE                 ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_DARK_OAK_FENCE               ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_ACACIA_FENCE                 ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_SPRUCE_DOOR                  ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_BIRCH_DOOR                   ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_JUNGLE_DOOR                  ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_ACACIA_DOOR                  ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_DARK_OAK_DOOR                ].m_BlastResistance = 0.99f;
	Info[E_BLOCK_END_ROD                      ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_CHORUS_PLANT                 ].m_BlastResistance = 0.21f;
	Info[E_BLOCK_CHORUS_FLOWER                ].m_BlastResistance = 0.21f;
	Info[E_BLOCK_PURPUR_BLOCK                 ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_PURPUR_DOUBLE_SLAB           ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_PURPUR_PILLAR                ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_PURPUR_SLAB                  ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_PURPUR_STAIRS                ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_END_BRICKS                   ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_BEETROOTS                    ].m_BlastResistance = 0.09f;
	Info[E_BLOCK_GRASS_PATH                   ].m_BlastResistance = 0.285f;
	Info[E_BLOCK_END_GATEWAY                  ].m_BlastResistance = 1080000.09f;
	Info[E_BLOCK_REPEATING_COMMAND_BLOCK      ].m_BlastResistance = 1080000.09f;
	Info[E_BLOCK_CHAIN_COMMAND_BLOCK          ].m_BlastResistance = 1080000.09f;
	Info[E_BLOCK_FROSTED_ICE                  ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_MAGMA                        ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_NETHER_WART_BLOCK            ].m_BlastResistance = 0.39f;
	Info[E_BLOCK_RED_NETHER_BRICK             ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_BONE_BLOCK                   ].m_BlastResistance = 0.69f;
	Info[E_BLOCK_END_BRICKS                   ].m_BlastResistance = 0.36f;
	Info[E_BLOCK_STRUCTURE_VOID               ].m_BlastResistance = 1080000.09f;
	Info[E_BLOCK_OBSERVER                     ].m_BlastResistance = 1.14f;
	Info[E_BLOCK_WHITE_SHULKER_BOX            ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_ORANGE_SHULKER_BOX           ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_MAGENTA_SHULKER_BOX          ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_LIGHT_BLUE_SHULKER_BOX       ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_YELLOW_SHULKER_BOX           ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_LIME_SHULKER_BOX             ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_PINK_SHULKER_BOX             ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_GRAY_SHULKER_BOX             ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_LIGHT_GRAY_SHULKER_BOX       ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_CYAN_SHULKER_BOX             ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_PURPLE_SHULKER_BOX           ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_BLUE_SHULKER_BOX             ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_BROWN_SHULKER_BOX            ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_GREEN_SHULKER_BOX            ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_RED_SHULKER_BOX              ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_BLACK_SHULKER_BOX            ].m_BlastResistance = 1.89f;
	Info[E_BLOCK_WHITE_GLAZED_TERRACOTTA      ].m_BlastResistance = 0.51f;  // 7
	Info[E_BLOCK_ORANGE_GLAZED_TERRACOTTA     ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_MAGENTA_GLAZED_TERRACOTTA    ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_LIGHT_BLUE_GLAZED_TERRACOTTA ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_YELLOW_GLAZED_TERRACOTTA     ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_LIME_GLAZED_TERRACOTTA       ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_PINK_GLAZED_TERRACOTTA       ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_GRAY_GLAZED_TERRACOTTA       ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_LIGHT_GRAY_GLAZED_TERRACOTTA ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_CYAN_GLAZED_TERRACOTTA       ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_PURPLE_GLAZED_TERRACOTTA     ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_BLUE_GLAZED_TERRACOTTA       ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_BROWN_GLAZED_TERRACOTTA      ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_GREEN_GLAZED_TERRACOTTA      ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_RED_GLAZED_TERRACOTTA        ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_BLACK_GLAZED_TERRACOTTA      ].m_BlastResistance = 0.51f;
	Info[E_BLOCK_CONCRETE                     ].m_BlastResistance = 0.63f;  // 9
	Info[E_BLOCK_CONCRETE_POWDER              ].m_BlastResistance = 0.24f;
	Info[E_BLOCK_STRUCTURE_BLOCK              ].m_BlastResistance = 1090000.09f;
}
