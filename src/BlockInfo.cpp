...
void cBlockInfo::Initialize(cBlockInfoArray & a_Info)
{
	...
	a_Info[E_BLOCK_AIR                 ].m_Hardness = 0;
	a_Info[E_BLOCK_STONE               ].m_Hardness = 1.5;
	a_Info[E_BLOCK_GRASS               ].m_Hardness = 0.6;
	a_Info[E_BLOCK_DIRT                ].m_Hardness = 0.5;
	a_Info[E_BLOCK_COBBLESTONE         ].m_Hardness = 2;
	a_Info[E_BLOCK_PLANKS              ].m_Hardness = 2;
	a_Info[E_BLOCK_SAPLING             ].m_Hardness = 0;
	a_Info[E_BLOCK_BEDROCK             ].m_Hardness = -1;
	a_Info[E_BLOCK_WATER               ].m_Hardness = 100;
	a_Info[E_BLOCK_STATIONARY_WATER    ].m_Hardness = 100;
	a_Info[E_BLOCK_LAVA                ].m_Hardness = 100;
	a_Info[E_BLOCK_STATIONARY_LAVA     ].m_Hardness = 100;
	a_Info[E_BLOCK_SAND                ].m_Hardness = 0.5;
	a_Info[E_BLOCK_GRAVEL              ].m_Hardness = 0.6;
	a_Info[E_BLOCK_GOLD_ORE            ].m_Hardness = 3;
	a_Info[E_BLOCK_IRON_ORE            ].m_Hardness = 3;
	a_Info[E_BLOCK_COAL_ORE            ].m_Hardness = 3;
	a_Info[E_BLOCK_LOG                 ].m_Hardness = 2;
	a_Info[E_BLOCK_LEAVES              ].m_Hardness = 0.2;
	a_Info[E_BLOCK_SPONGE              ].m_Hardness = 0.6;
	a_Info[E_BLOCK_GLASS               ].m_Hardness = 0.3;
	a_Info[E_BLOCK_LAPIS_ORE           ].m_Hardness = 3;
	a_Info[E_BLOCK_LAPIS_BLOCK         ].m_Hardness = 3;
	a_Info[E_BLOCK_DISPENSER           ].m_Hardness = 3.5;
	a_Info[E_BLOCK_SANDSTONE           ].m_Hardness = 0.8;
	a_Info[E_BLOCK_NOTE_BLOCK          ].m_Hardness = 0.8;
	a_Info[E_BLOCK_BED                 ].m_Hardness = 0.2;
	a_Info[E_BLOCK_POWERED_RAIL        ].m_Hardness = 0.7;
	a_Info[E_BLOCK_DETECTOR_RAIL       ].m_Hardness = 0.7;
	a_Info[E_BLOCK_STICKY_PISTON       ].m_Hardness = 0.5;
	a_Info[E_BLOCK_COBWEB              ].m_Hardness = 4;
	a_Info[E_BLOCK_TALL_GRASS          ].m_Hardness = 0;
	a_Info[E_BLOCK_DEAD_BUSH           ].m_Hardness = 0;
	a_Info[E_BLOCK_PISTON              ].m_Hardness = 0.5;
	a_Info[E_BLOCK_PISTON_EXTENSION    ].m_Hardness = 0.5;
	a_Info[E_BLOCK_WOOL                ].m_Hardness = 0.8;
	a_Info[E_BLOCK_PISTON_MOVED_BLOCK  ].m_Hardness = -1;
	a_Info[E_BLOCK_DANDELION           ].m_Hardness = 0;
	a_Info[E_BLOCK_FLOWER              ].m_Hardness = 0;
	a_Info[E_BLOCK_BROWN_MUSHROOM      ].m_Hardness = 0;
	a_Info[E_BLOCK_RED_MUSHROOM        ].m_Hardness = 0;
	a_Info[E_BLOCK_GOLD_BLOCK          ].m_Hardness = 3;
	a_Info[E_BLOCK_IRON_BLOCK          ].m_Hardness = 5;
	a_Info[E_BLOCK_DOUBLE_STONE_SLAB   ].m_Hardness = 2;
	a_Info[E_BLOCK_STONE_SLAB          ].m_Hardness = 2;
	a_Info[E_BLOCK_BRICK               ].m_Hardness = 2;
	a_Info[E_BLOCK_TNT                 ].m_Hardness = 0;
	a_Info[E_BLOCK_BOOKCASE            ].m_Hardness = 1.5;
	a_Info[E_BLOCK_MOSSY_COBBLESTONE   ].m_Hardness = 2;
	a_Info[E_BLOCK_OBSIDIAN            ].m_Hardness = 50;
	a_Info[E_BLOCK_TORCH               ].m_Hardness = 0;
	a_Info[E_BLOCK_FIRE                ].m_Hardness = 0;
	a_Info[E_BLOCK_MOB_SPAWNER         ].m_Hardness = 5;
	a_Info[E_BLOCK_OAK_WOOD_STAIRS     ].m_Hardness = 2;
	a_Info[E_BLOCK_CHEST               ].m_Hardness = 2.5;
	a_Info[E_BLOCK_REDSTONE_WIRE       ].m_Hardness = 0;
	a_Info[E_BLOCK_DIAMOND_ORE         ].m_Hardness = 3;
	a_Info[E_BLOCK_DIAMOND_BLOCK       ].m_Hardness = 5;
	a_Info[E_BLOCK_CRAFTING_TABLE      ].m_Hardness = 2.5;
	a_Info[E_BLOCK_CROPS               ].m_Hardness = 0;
	a_Info[E_BLOCK_FARMLAND            ].m_Hardness = 0.6;
	a_Info[E_BLOCK_FURNACE             ].m_Hardness = 3.5;
	a_Info[E_BLOCK_LIT_FURNACE         ].m_Hardness = 3.5;
	a_Info[E_BLOCK_SIGN_POST           ].m_Hardness = 1;
	a_Info[E_BLOCK_OAK_DOOR            ].m_Hardness = 3;
	a_Info[E_BLOCK_LADDER              ].m_Hardness = 0.4;
	a_Info[E_BLOCK_RAIL                ].m_Hardness = 0.7;
	a_Info[E_BLOCK_COBBLESTONE_STAIRS  ].m_Hardness = 2;
	a_Info[E_BLOCK_WALLSIGN            ].m_Hardness = 1;
	a_Info[E_BLOCK_LEVER               ].m_Hardness = 0.5;
	a_Info[E_BLOCK_STONE_PRESSURE_PLATE].m_Hardness = 0.5;
	a_Info[E_BLOCK_IRON_DOOR           ].m_Hardness = 5;
	a_Info[E_BLOCK_WOODEN_PRESSURE_PLATE].m_Hardness = 0.5;
	a_Info[E_BLOCK_REDSTONE_ORE        ].m_Hardness = 3;
	a_Info[E_BLOCK_REDSTONE_ORE_GLOWING].m_Hardness = 0.625;
	a_Info[E_BLOCK_REDSTONE_TORCH_OFF  ].m_Hardness = 0;
	a_Info[E_BLOCK_REDSTONE_TORCH_ON   ].m_Hardness = 0;
	a_Info[E_BLOCK_STONE_BUTTON        ].m_Hardness = 0.5;
	a_Info[E_BLOCK_SNOW                ].m_Hardness = 0.1;
	a_Info[E_BLOCK_ICE                 ].m_Hardness = 0.5;
	a_Info[E_BLOCK_SNOW_BLOCK          ].m_Hardness = 0.2;
	a_Info[E_BLOCK_CACTUS              ].m_Hardness = 0.4;
	a_Info[E_BLOCK_CLAY                ].m_Hardness = 0.6;
	a_Info[E_BLOCK_SUGARCANE           ].m_Hardness = 0;
	a_Info[E_BLOCK_JUKEBOX             ].m_Hardness = 2;
	a_Info[E_BLOCK_FENCE               ].m_Hardness = 2;
	a_Info[E_BLOCK_PUMPKIN             ].m_Hardness = 1;
	a_Info[E_BLOCK_NETHERRACK          ].m_Hardness = 0.4;
	a_Info[E_BLOCK_SOULSAND            ].m_Hardness = 0.5;
	a_Info[E_BLOCK_GLOWSTONE           ].m_Hardness = 0.3;
	a_Info[E_BLOCK_NETHER_PORTAL       ].m_Hardness = -1;
	a_Info[E_BLOCK_JACK_O_LANTERN      ].m_Hardness = 1;
	a_Info[E_BLOCK_CAKE                ].m_Hardness = 0.5;
	a_Info[E_BLOCK_REDSTONE_REPEATER_OFF].m_Hardness = 0;
	a_Info[E_BLOCK_REDSTONE_REPEATER_ON].m_Hardness = 0;
	a_Info[E_BLOCK_STAINED_GLASS       ].m_Hardness = 0.3;
	a_Info[E_BLOCK_TRAPDOOR            ].m_Hardness = 3;
	a_Info[E_BLOCK_SILVERFISH_EGG      ].m_Hardness = 0.75;
	a_Info[E_BLOCK_STONE_BRICKS        ].m_Hardness = 1.5;
	a_Info[E_BLOCK_HUGE_BROWN_MUSHROOM ].m_Hardness = 0.2;
	a_Info[E_BLOCK_HUGE_RED_MUSHROOM   ].m_Hardness = 0.2;
	a_Info[E_BLOCK_IRON_BARS           ].m_Hardness = 5;
	a_Info[E_BLOCK_GLASS_PANE          ].m_Hardness = 0.3;
	a_Info[E_BLOCK_MELON               ].m_Hardness = 1;
	a_Info[E_BLOCK_PUMPKIN_STEM        ].m_Hardness = 0;
	a_Info[E_BLOCK_MELON_STEM          ].m_Hardness = 0;
	a_Info[E_BLOCK_VINES               ].m_Hardness = 0.2;
	a_Info[E_BLOCK_OAK_FENCE_GATE      ].m_Hardness = 2;
	a_Info[E_BLOCK_BRICK_STAIRS        ].m_Hardness = 2;
	a_Info[E_BLOCK_STONE_BRICK_STAIRS  ].m_Hardness = 1.5;
	a_Info[E_BLOCK_MYCELIUM            ].m_Hardness = 0.6;
	a_Info[E_BLOCK_LILY_PAD            ].m_Hardness = 0;
	a_Info[E_BLOCK_NETHER_BRICK        ].m_Hardness = 2;
	a_Info[E_BLOCK_NETHER_BRICK_FENCE  ].m_Hardness = 2;
	a_Info[E_BLOCK_NETHER_BRICK_STAIRS ].m_Hardness = 2;
	a_Info[E_BLOCK_NETHER_WART         ].m_Hardness = 0;
	a_Info[E_BLOCK_ENCHANTMENT_TABLE   ].m_Hardness = 5;
	a_Info[E_BLOCK_BREWING_STAND       ].m_Hardness = 0.5;
	a_Info[E_BLOCK_CAULDRON            ].m_Hardness = 2;
	a_Info[E_BLOCK_END_PORTAL          ].m_Hardness = -1;
	a_Info[E_BLOCK_END_PORTAL_FRAME    ].m_Hardness = -1;
	a_Info[E_BLOCK_END_STONE           ].m_Hardness = 3;
	a_Info[E_BLOCK_DRAGON_EGG          ].m_Hardness = 3;
	a_Info[E_BLOCK_REDSTONE_LAMP_OFF   ].m_Hardness = 0.3;
	a_Info[E_BLOCK_REDSTONE_LAMP_ON    ].m_Hardness = 0.3;
	a_Info[E_BLOCK_DOUBLE_WOODEN_SLAB  ].m_Hardness = 2;
	a_Info[E_BLOCK_WOODEN_SLAB         ].m_Hardness = 2;
	a_Info[E_BLOCK_COCOA_POD           ].m_Hardness = 0.2;
	a_Info[E_BLOCK_SANDSTONE_STAIRS    ].m_Hardness = 0.8;
	a_Info[E_BLOCK_EMERALD_ORE         ].m_Hardness = 3;
	a_Info[E_BLOCK_ENDER_CHEST         ].m_Hardness = 22.5;
	a_Info[E_BLOCK_TRIPWIRE_HOOK       ].m_Hardness = 0;
	a_Info[E_BLOCK_TRIPWIRE            ].m_Hardness = 0;
	a_Info[E_BLOCK_EMERALD_BLOCK       ].m_Hardness = 5;
	a_Info[E_BLOCK_SPRUCE_WOOD_STAIRS  ].m_Hardness = 2;
	a_Info[E_BLOCK_BIRCH_WOOD_STAIRS   ].m_Hardness = 2;
	a_Info[E_BLOCK_JUNGLE_WOOD_STAIRS  ].m_Hardness = 2;
	a_Info[E_BLOCK_COMMAND_BLOCK       ].m_Hardness = -1;
	a_Info[E_BLOCK_BEACON              ].m_Hardness = 3;
	a_Info[E_BLOCK_COBBLESTONE_WALL    ].m_Hardness = 2;
	a_Info[E_BLOCK_FLOWER_POT          ].m_Hardness = 0;
	a_Info[E_BLOCK_CARROTS             ].m_Hardness = 0;
	a_Info[E_BLOCK_POTATOES            ].m_Hardness = 0;
	a_Info[E_BLOCK_WOODEN_BUTTON       ].m_Hardness = 0.5;
	a_Info[E_BLOCK_HEAD                ].m_Hardness = 1;
	a_Info[E_BLOCK_ANVIL               ].m_Hardness = 5;
	a_Info[E_BLOCK_TRAPPED_CHEST       ].m_Hardness = 2.5;
	a_Info[E_BLOCK_LIGHT_WEIGHTED_PRESSURE_PLATE].m_Hardness = 0.5;
	a_Info[E_BLOCK_HEAVY_WEIGHTED_PRESSURE_PLATE].m_Hardness = 0.5;
	a_Info[E_BLOCK_INACTIVE_COMPARATOR ].m_Hardness = 0;
	a_Info[E_BLOCK_ACTIVE_COMPARATOR   ].m_Hardness = 0;
	a_Info[E_BLOCK_DAYLIGHT_SENSOR     ].m_Hardness = 0.2;
	a_Info[E_BLOCK_BLOCK_OF_REDSTONE   ].m_Hardness = 5;
	a_Info[E_BLOCK_NETHER_QUARTZ_ORE   ].m_Hardness = 3;
	a_Info[E_BLOCK_HOPPER              ].m_Hardness = 3;
	a_Info[E_BLOCK_QUARTZ_BLOCK        ].m_Hardness = 0.8;
	a_Info[E_BLOCK_QUARTZ_STAIRS       ].m_Hardness = 0.8;
	a_Info[E_BLOCK_ACTIVATOR_RAIL      ].m_Hardness = 0.7;
	a_Info[E_BLOCK_DROPPER             ].m_Hardness = 3.5;
	a_Info[E_BLOCK_STAINED_CLAY        ].m_Hardness = 1.25;
	a_Info[E_BLOCK_STAINED_GLASS_PANE  ].m_Hardness = 0.3;
	a_Info[E_BLOCK_NEW_LEAVES          ].m_Hardness = 0.2;
	a_Info[E_BLOCK_NEW_LOG             ].m_Hardness = 2;
	a_Info[E_BLOCK_ACACIA_WOOD_STAIRS  ].m_Hardness = 2;
	a_Info[E_BLOCK_DARK_OAK_WOOD_STAIRS].m_Hardness = 2;
	a_Info[E_BLOCK_SLIME_BLOCK         ].m_Hardness = 0;
	a_Info[E_BLOCK_BARRIER             ].m_Hardness = -1;
	a_Info[E_BLOCK_IRON_TRAPDOOR       ].m_Hardness = 5;
	a_Info[E_BLOCK_PRISMARINE_BLOCK    ].m_Hardness = 1.5;
	a_Info[E_BLOCK_SEA_LANTERN         ].m_Hardness = 0.3;
	a_Info[E_BLOCK_HAY_BALE            ].m_Hardness = 0.5;
	a_Info[E_BLOCK_CARPET              ].m_Hardness = 0.1;
	a_Info[E_BLOCK_HARDENED_CLAY       ].m_Hardness = 1.25;
	a_Info[E_BLOCK_BLOCK_OF_COAL       ].m_Hardness = 5;
	a_Info[E_BLOCK_PACKED_ICE          ].m_Hardness = 0.5;
	a_Info[E_BLOCK_BIG_FLOWER          ].m_Hardness = 0;
	a_Info[E_BLOCK_STANDING_BANNER     ].m_Hardness = 1;
	a_Info[E_BLOCK_WALL_BANNER         ].m_Hardness = 1;
	a_Info[E_BLOCK_INVERTED_DAYLIGHT_SENSOR].m_Hardness = 0.2;
	a_Info[E_BLOCK_RED_SANDSTONE       ].m_Hardness = 0.8;
	a_Info[E_BLOCK_RED_SANDSTONE_STAIRS].m_Hardness = 0.8;
	a_Info[E_BLOCK_DOUBLE_RED_SANDSTONE_SLAB].m_Hardness = 2;
	a_Info[E_BLOCK_RED_SANDSTONE_SLAB  ].m_Hardness = 2;
	a_Info[E_BLOCK_SPRUCE_FENCE_GATE   ].m_Hardness = 2;
	a_Info[E_BLOCK_BIRCH_FENCE_GATE    ].m_Hardness = 2;
	a_Info[E_BLOCK_JUNGLE_FENCE_GATE   ].m_Hardness = 2;
	a_Info[E_BLOCK_DARK_OAK_FENCE_GATE ].m_Hardness = 2;
	a_Info[E_BLOCK_ACACIA_FENCE_GATE   ].m_Hardness = 2;
	a_Info[E_BLOCK_SPRUCE_FENCE        ].m_Hardness = 2;
	a_Info[E_BLOCK_BIRCH_FENCE         ].m_Hardness = 2;
	a_Info[E_BLOCK_JUNGLE_FENCE        ].m_Hardness = 2;
	a_Info[E_BLOCK_DARK_OAK_FENCE      ].m_Hardness = 2;
	a_Info[E_BLOCK_ACACIA_FENCE        ].m_Hardness = 2;
	a_Info[E_BLOCK_SPRUCE_DOOR         ].m_Hardness = 3;
	a_Info[E_BLOCK_BIRCH_DOOR          ].m_Hardness = 3;
	a_Info[E_BLOCK_JUNGLE_DOOR         ].m_Hardness = 3;
	a_Info[E_BLOCK_ACACIA_DOOR         ].m_Hardness = 3;
	a_Info[E_BLOCK_DARK_OAK_DOOR       ].m_Hardness = 3;
	// Synonym or ID compatibility
	a_Info[E_BLOCK_YELLOW_FLOWER] = a_Info[E_BLOCK_DANDELION];
	a_Info[E_BLOCK_RED_ROSE] = a_Info[E_BLOCK_FLOWER];
	a_Info[E_BLOCK_WOODEN_DOOR] = a_Info[E_BLOCK_OAK_DOOR];
	a_Info[E_BLOCK_FENCE_GATE] = a_Info[E_BLOCK_OAK_FENCE_GATE];
	a_Info[E_BLOCK_WOODEN_STAIRS] = a_Info[E_BLOCK_OAK_WOOD_STAIRS];
}
