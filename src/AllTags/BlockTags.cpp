...
namespace BlockTags
{
	...
	{
			if (CeilingHangingSigns(a_block)) { return true; }
			if (WallHangingSigns(a_block)) { return true; }
			return false;
	}
	bool AllSigns(BlockType a_block)
	{
			if (Signs(a_block)) { return true; }
			if (AllHangingSigns(a_block)) { return true; }
			return false;
	}
	...
	{
			if (AnimalsSpawnableOn(a_block)) { return true; }
			if (BadlandsTerracotta(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (Dirt(a_block)) { return true; }
			if (Sand(a_block)) { return true; }
			if (Terracotta(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (BaseStoneOverworld(a_block)) { return true; }
			if (Dirt(a_block)) { return true; }
			if (Terracotta(a_block)) { return true; }
			switch(a_block) {
				case BlockType::RedSand:
	...
	{
			if (SmallDripleafPlaceable(a_block)) { return true; }
			if (Dirt(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (WoodenButtons(a_block)) { return true; }
			if (StoneButtons(a_block)) { return true; }
			return false;
	}
	bool CamelSandStepSoundBlocks(BlockType a_block)
	{
			if (Sand(a_block)) { return true; }
			if (ConcretePowder(a_block)) { return true; }
			return false;
	}
	...
	{
			if (WoolCarpets(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (Logs(a_block)) { return true; }
			if (Leaves(a_block)) { return true; }
			if (WartBlocks(a_block)) { return true; }
			return false;
	}
	...
	{
			if (CoralPlants(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (Beehives(a_block)) { return true; }
			return false;
	}
	bool Doors(BlockType a_block)
	{
			if (WoodenDoors(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (Replaceable(a_block)) { return true; }
			return false;
	}
	bool EndermanHoldable(BlockType a_block)
	{
			if (SmallFlowers(a_block)) { return true; }
			if (Dirt(a_block)) { return true; }
			switch(a_block) {
				case BlockType::Sand:
				case BlockType::RedSand:
	...
	{
			if (Climbable(a_block)) { return true; }
			switch(a_block) {
				case BlockType::SweetBerryBush:
	...
	{
			if (WoodenFences(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (SmallFlowers(a_block)) { return true; }
			if (TallFlowers(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (ShulkerBoxes(a_block)) { return true; }
			if (GoldOres(a_block)) { return true; }
			switch(a_block) {
				case BlockType::GoldBlock:
	...
	{
			if (NeedsDiamondTool(a_block)) { return true; }
			if (NeedsIronTool(a_block)) { return true; }
			if (NeedsStoneTool(a_block)) { return true; }
			return false;
	}
	...
	{
			if (InfiniburnOverworld(a_block)) { return true; }
			switch(a_block) {
				case BlockType::Bedrock:
							return true;
					default: return false;
	...
	{
			if (FeaturesCannotReplace(a_block)) { return true; }
			if (Leaves(a_block)) { return true; }
			if (Logs(a_block)) { return true; }
			return false;
	}
	...
	{
			if (LogsThatBurn(a_block)) { return true; }
			if (CrimsonStems(a_block)) { return true; }
			if (WarpedStems(a_block)) { return true; }
			return false;
	}
	bool LogsThatBurn(BlockType a_block)
	{
			if (DarkOakLogs(a_block)) { return true; }
			if (OakLogs(a_block)) { return true; }
			if (AcaciaLogs(a_block)) { return true; }
			if (BirchLogs(a_block)) { return true; }
			if (JungleLogs(a_block)) { return true; }
			if (SpruceLogs(a_block)) { return true; }
			if (MangroveLogs(a_block)) { return true; }
			if (CherryLogs(a_block)) { return true; }
			return false;
	}
	bool LushGroundReplaceable(BlockType a_block)
	{
			if (MossReplaceable(a_block)) { return true; }
			switch(a_block) {
				case BlockType::Clay:
				case BlockType::Gravel:
				case BlockType::Sand:
	...
	{
			if (BaseStoneOverworld(a_block)) { return true; }
			if (CaveVines(a_block)) { return true; }
			if (Dirt(a_block)) { return true; }
			return false;
	}
	...
	{
			if (BaseStoneOverworld(a_block)) { return true; }
			if (BaseStoneNether(a_block)) { return true; }
			if (Dirt(a_block)) { return true; }
			if (Nylium(a_block)) { return true; }
			if (WartBlocks(a_block)) { return true; }
			switch(a_block) {
	...
	bool OverworldCarverReplaceables(BlockType a_block)
	{
			...
			if (Sand(a_block)) { return true; }
			if (Terracotta(a_block)) { return true; }
			if (IronOres(a_block)) { return true; }
			if (CopperOres(a_block)) { return true; }
			switch(a_block) {
				case BlockType::Water:
				case BlockType::Gravel:
				case BlockType::SuspiciousGravel:
	...
	{
			if (WoodenPressurePlates(a_block)) { return true; }
			if (StonePressurePlates(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (SculkReplaceable(a_block)) { return true; }
			switch(a_block) {
				case BlockType::DeepslateBricks:
				case BlockType::DeepslateTiles:
				case BlockType::CobbledDeepslate:
	...
	{
			if (StandingSigns(a_block)) { return true; }
			if (WallSigns(a_block)) { return true; }
			return false;
	}
	bool Slabs(BlockType a_block)
	{
			if (WoodenSlabs(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (OverworldNaturalLogs(a_block)) { return true; }
			switch(a_block) {
				case BlockType::Stone:
				case BlockType::PackedIce:
				case BlockType::IronOre:
	...
	{
			if (WoodenStairs(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (Leaves(a_block)) { return true; }
			if (Saplings(a_block)) { return true; }
			if (SmallFlowers(a_block)) { return true; }
			if (Crops(a_block)) { return true; }
			switch(a_block) {
				case BlockType::ShortGrass:
	...
	{
			if (WoodenTrapdoors(a_block)) { return true; }
			switch(a_block) {
	...
	{
			if (Corals(a_block)) { return true; }
			if (WallCorals(a_block)) { return true; }
			switch(a_block) {
				case BlockType::Seagrass:
							return true;
					default: return false;
	...
	{
			if (FenceGates(a_block)) { return true; }
			return false;
	}
	...
	{
			if (Signs(a_block)) { return true; }
			if (Banners(a_block)) { return true; }
			if (PressurePlates(a_block)) { return true; }
			switch(a_block) {
