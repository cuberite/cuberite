			...
			{
				{
					...
					Desc = "Spawns an armor stand at the given coordinates and with the given orientation on the Y axis. Returns the UniqueID of the spawned armor stand, or {{cEntity#INVALID_ID|cEntity#INVALID_ID}} on failure.",
				},
			},
			SpawnBoat =
			{
