	...
	a_ChunkDesc:SetHeight(0, 0, Height + 1);
		...
		cClientHandle =
		{
			...
			Functions =
			{
				...
				SendHideTitle = { Params = "", Return = "", Notes = "Hides the title. This makes the title and subtitle disappear, but if you call SendTitleTimes() the same title and subtitle will appear again." },
				SendPluginMessage = { Params = "Channel, Message", Return = "", Notes = "Sends the plugin message on the specified channel." },
				SendResetTitle = { Params = "", Return = "", Notes = "Resets and hides the title but not the subtitle." },
				SendSetSubTitle = { Params = "{{cCompositeChat|SubTitle}}", Return = "", Notes = "Sends the subtitle to the client. Doesn't make the client display it yet, use SendTitleTimes() to show both the title and the subtitle." },
				SendSetRawSubTitle = { Params = "{{AString|RawSubTitle}}", Return = "", Notes = "Sends the raw subtitle to the client. Doesn't make the client display it yet, use SendTitleTimes() to show both the title and the subtitle." },
				SendSetTitle = { Params = "{{cCompositeChat|Title}}", Return = "", Notes = "Sends the title to the client. Doesn't make the client display it yet, use SendTitleTimes() to show both the title and the subtitle." },
				SendSetRawTitle = { Params = "{{AString|RawTitle}}", Return = "", Notes = "Sends the raw title to the client. Doesn't make the client display it yet, use SendTitleTimes() to show both the title and the subtitle." },
				SendTitleTimes = { Params = "FadeInTicks, DisplayTicks, FadeOutTicks", Return = "", Notes = "Sends the request to display the title and subtitle, previously set with SendSetTitle, SendSetRawTitle, SendSetSubTitle and SendSetRawSubTitle, to the client." },
