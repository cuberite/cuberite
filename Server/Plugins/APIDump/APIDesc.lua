...
local Item5 = cItem(E_ITEM_DIAMOND_CHESTPLATE, 1, 0, "thorns=1;unbreaking=3");
		...
		{
			Desc = [[
This class contains the information for a signed or writeable book: The author, title and the pages.
A page of the writeable book is a simple string. For a signed book it can be a json string.
Use {{cCompositeChat}} to create a more complex page with formatting.
]],
			Functions =
			{
				AddPage =
