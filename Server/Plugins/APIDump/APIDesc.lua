...
function OnChunkGenerated(a_World, a_ChunkX, a_ChunkZ, a_ChunkDesc)
	...
	a_ChunkDesc:SetHeight(0, 0, Height + 1);
        ...
        SendHideTitle = { Params = "", Return = "", Notes = "Sends the client to hide the title." },
				SendPluginMessage = { Params = "Channel, Message", Return = "", Notes = "Sends the plugin message on the specified channel." },
        SendResetTitle = { Params = "", Return = "", Notes = "Sends the client to reset the title." },
        SendSetSubTitle = { Params = "SubTitle", Return = "", Notes = "Sends the client the subtitle." },
        SendSetRawSubTitle = { Params = "RawSubTitle", Return = "", Notes = "Sends the client the raw subtitle." },
        SendSetTitle = { Params = "Title", Return = "", Notes = "Sends the client the title." },
        SendSetRawTitle = { Params = "RawTitle", Return = "", Notes = "Sends the client the raw title." },
        SendTitleTimes = { Params = "FadeInTicks, DisplayTicks, FadeOutTicks", Return = "", Notes = "Sends the client the title times and shows the title." },
